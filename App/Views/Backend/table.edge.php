...
@section('css')
<link rel="stylesheet" href="{!! get_asset('Backend/css/jquery.dataTables.min.css', 'v=1.0') !!}">
@endsection
...
@section('js')
<script type="application/javascript" src="{!! get_asset('Backend/js/jquery.dataTables.min.js', 'v=1.0') !!}"/></script>
<script type="application/javascript" src="{!! get_asset('Backend/js/datatables.init.js', 'v=1.0') !!}"/></script>
@endsection
