        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ $product->productName }} | Ürün Düzenle</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div id="wizard_Service" class="tab-pane" role="tabpanel">
                                    <div class="row" style="margin-top: 15px;margin-left: 7px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="productName" name="productName" class="form-control" placeholder="Ürün Adı" value="{{ $product->productName }}" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class=" form-control wide" name="schoolId" id="schoolId" required>
                                                ...
                                                <option value="{{ $school->id }}" {{ $product->schoolId == $school->id ?  'selected' : '' }}>{{ $school->schoolName }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="productBarkod" name="productBarkod" class="form-control" value="{{ $product->productBarkod }}" placeholder="Ürün Barkodu" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row" style="margin-top: 15px;margin-left: 7px;">
                                        ...
                                        <div class="mb-3" id="divCinsiyet">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="cinsiyet" id="inlineRadio11" value="1"  {{ $product->cinsiyet == 1 ?  'checked' : '' }}>
                                                <label class="form-check-label" for="inlineRadio11">Bay</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="cinsiyet" id="inlineRadio21" value="0"  {{ $product->cinsiyet == 0 ?  'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="fileAstar" id="inlineRadio1" value="3"   {{ $product->fileAstar == 3 ?  'checked' : '' }}>
                                                <label class="form-check-label" for="inlineRadio1">File/Astar</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="fileAstar" id="inlineRadio1" value="2"   {{ $product->fileAstar == 2 ?  'checked' : '' }}>
                                                <label class="form-check-label" for="inlineRadio1">File</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="fileAstar" id="inlineRadio2" value="1"  {{ $product->fileAstar == 1 ?  'checked' : '' }}>
                                                <label class="form-check-label" for="inlineRadio2">Astar</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="fileAstar" id="inlineRadio2" value="0"   {{ $product->fileAstar == 0 ?  'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="kumasTipId" id="kumasTipId" required>
                                                        ...
                                                        <option value="{{ $att->id }}"  {{ $product->kumasTipId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="anaBedenCodeId" id="anaBedenCodeId" required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->anaBedenCodeId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="productColorCodeId" id="productColorCodeId" required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->productColorCodeId == $att->id ?  'selected' : '' }}>{{ $att->text }} ({{ $att->code }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="cepModelId" id="cepModelId"  required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->cepModelId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="ribanaId" id="ribanaId" required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->ribanaId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="kolTipiId" id="kolTipiId" required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->kolTipiId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-11">
                                                    <select class=" form-control wide" name="belLastikId" id="belLastikId" required>
                                                        ...
                                                        <option value="{{ $att->id }}" {{ $product->belLastikId == $att->id ?  'selected' : '' }}>{{ $att->text }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-1">
                                ...
                                <div id="wizard_Details" class="tab-pane" role="tabpanel">
                                    <div class="row" style="margin-top: 15px;margin-left: 7px;">
                                                        ...
                                                        <div id="uploadCompleted" class="row">
                                                            ...
                                                            @foreach(json_decode($product->gallery) as $image)
                                                                <div class="col-md-4 mt-2">
                                                                    ...
                                                                    <img src="{{PUBLIC_DIR}}/uploads/urun/{{ $image }}" alt="" style="width: 100%;">
                                                                    <input type="hidden" class="imagex" name="image[]" value="{{ $image }}">
                                                                </div>
                                                            @endforeach
                                                            @endif
                                                        </div>
                                        ...
                                        <div>
                                            <button type="button" id="saveButton" class="btn btn-success" data-loading-text="<i class='fas fa-circle-notch fa-spin'></i>" style="float: right;width: 160px;position: relative;right: 30px;">Güncelle</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        function myGreeting() {
            $(".js-category-select").trigger("change");
        }
