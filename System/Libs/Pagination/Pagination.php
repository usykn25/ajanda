...
class Pagination
{
	...
	public function printLinks()
	{
		...
		foreach ($this->getPages() as $page) {
			if ($page['url'])
				$html .= '<li' . ($page['isCurrent'] ? ' class="page-item ' . $this->liActiveClass . '"' : ' class="page-item"') . '><a href="' . $page['url'] . '" class="page-link">' . $page['num'] . '</a></li>';
			else
				$html .= '<li' . (!is_null($this->liClass) ? ' class="page-item ' . $this->liClass . '"' : ' class="page-item"') . '><span>' . $page['num'] . '</span></li>';
		}
